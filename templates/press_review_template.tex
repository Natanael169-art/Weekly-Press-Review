...
with open("press_review_template.tex", mode="w", encoding="utf-8") as f:
    f.write(corrected_tex_template)

print("Fichier LaTeX corrigé généré : press_review_template.tex")
